                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="dashboard.php" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2">E-Commerce</a>
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-11" aria-controls="submenu-12"><i class="fas fa-fw fa-table"></i>Pin</a>
                             ...
                             <li class="nav-item">
                                <a class="nav-link" href="../agent-list.php"  ><i class="fas fa-dollar-sign"></i>Agent List</a>
                               
                            </li>
                             <li class="nav-item">
                                <a class="nav-link" href="../login_agent.php"  ><i class="fas fa-dollar-sign"></i>Login To Agent</a>
                               
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../withdraw_req.php"  ><i class="fas fa-dollar-sign"></i>Withdraw Requests</a>
                               
                            </li> 
                             <li class="nav-item">
                                <a class="nav-link" href="../pack_add-del.php"  ><i class="fas fa-dollar-sign"></i>Package ADD/DEL</a>
                               
                            </li> 
                            <li class="nav-item">
                                <a class="nav-link" href="../redeem.php"  ><i class="fas fa-dollar-sign"></i>Daily Payments</a>
                               
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../pair-income.php"  ><i class="fas fa-dollar-sign"></i>Pair Income</a>
