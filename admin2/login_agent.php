            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Login in any agent acoount</h2>
                                <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">login To Any Agent</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <!-- ============================================================== -->
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Agent Login IDs</h5>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                   <?php
                                                    $a=0;
                                                    $agent_list= mysqli_query($conn,"SELECT * FROM users"); 
                                                    while($data=mysqli_fetch_array($agent_list)){
                                                    	$id=$data['user_id'];
                                                    	?>
                                                    	<tr>
                                                    		<td><?php echo ++$a ?></td>
                                                    		...
                                                    		<td><?php echo ($data['ub_status'])?"Blocked":"Unblocked"?></td>
                                                    		<td>
                 <form method="POST" action="../admin/elements/redirect.php">
