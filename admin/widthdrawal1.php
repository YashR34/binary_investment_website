                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">WITHDRAWAL</h2>
                            ...
                            <div class="card" style="background-color: #251C50; border-radius: 3vh;">
                                ...
                                <div class="card-body" >
                                    <form class="needs-validation" method="POST" action="elements/redirect.php">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom01" style="color:#fff;font-size:20px"><b>AVAILABLE BALANCE : $<?php echo $data['e_wallet']?></b></label>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                
                                                <label for="validationCustom01" style="color:#fff;">WITHDRAWAL AMOUNT</label>
                                                <input type="text" pattern="[\d]+" class="form-control" id="validationCustom01"  required name="amount"style="background:#dddddd;border-radius: 20vh;" placeholder="amount">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-top: 10px;">
                                                <button class="btn btn-success" type="submit" name="withdrawal" style="border-radius: 20vh;">SUBMIT</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
