                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Revenue Plans </h2>
                                    <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Plan</a></li>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-section" id="overview">
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <h2>Disclaimer</h2>
                                            <p class="lead">Crypto currency investment are subject to market risks, read all scheme related document carefully. Investment in crypto currently involves financial risk such as:</p>
                                            <ul >
                                                <li>Trading volume.</li>
                                                <li>Settlement risk.</li>
                                                <li>Liquidity risk.</li>
                                                <li>Default risk including the possible loss of pricipal.</li>
                                            </ul>
                                            <p class="lead">An  investment disclaimer is statement declaring that there is an inherent risk investiing and that the party facilitating the investment does not provide any guaranteed retuen on any investment made.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!--<div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="cards">
                                    <h3 class="section-title"> Income Plans</h3>
                                    <p>We have different kind of income plan. You can choose any of the plans.</p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="image-card">
                                    <h3 class="section-title">Plan Options</h3>
                                    <p>we have different kind of investiing options. You can choose suitable plan from the options given below:</p>
                                </div>
                            </div>
                            <!-- <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <img class="img-fluid" src="assets/images/income/DirectIncome.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        ...
                                        <a href="packages.php" class="btn btn-primary">MORE INFO</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <img class="img-fluid" src="assets/images/income/MatchingIncome.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h3 class="card-title">Matching Income</h3>
                                        <p class="card-text">Faucibus orci luctus et ultrices posuere cubilia Curae Integer quis ipsum in augue posuere congue.</p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <img class="img-fluid" src="assets/images/income/MatchingLevelIncome.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h3 class="card-title">Matching Level Income</h3>
                                        <p class="card-text">Faucibus orci luctus et ultrices posuere cubilia Curae Integer quis ipsum in augue posuere congue.</p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <img class="img-fluid" src="assets/images/income/StackingIncome.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h3 class="card-title">Stacking Income</h3>
                                        <p class="card-text">Faucibus orci luctus et ultrices posuere cubilia Curae Integer quis ipsum in augue posuere congue.</p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <img class="img-fluid" src="assets/images/income/SponsorStackingIncome.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h3 class="card-title">Sponsor Stacking Level Income</h3>
                                        <p class="card-text">Faucibus orci luctus et ultrices posuere cubilia Curae Integer quis ipsum in augue posuere congue.</p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <img class="img-fluid" src="assets/images/income/RewardIncome.jpg" alt="Card image cap">
                                    <div class="card-body">
