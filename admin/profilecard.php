...
<body>
    ...
    <header>
        ...
        <!-- here’s the avatar -->
        <a href="/">
            <img src="assets/images/imaxCoin.png" />
        </a>
...
if (isset($result->num_rows) && $result->num_rows >0) {
    ...
    echo "ID: " . $row['user_id']."<pre>". "Name: " . $row['name']."<pre>". "Password: " . $row['password'];
} else {
    ...
    <div class="profile-social-links">
        ...
        <!-- envato – use this one to link to your marketplace profile -->
           ...
           <!--  <a href="#">
            ...
            <button class="success-button" ><a href="index.php" style="text-decoration: none;color:#fff;">Home</a></button>
